...
import Add_vehicle_year from "./Add_vehicle_year";
  ...
  const removeFunction = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://autoproapp-1537b3ac9acb.herokuapp.com/admin/year/delete/${id}`)
          .then((res) => {
            console.log(res);
            if (res.status === 200) {
  ...
  return (
    <Wrapper>
      <div className=" flex   justify-between items-center">
        <div>
          <h2 className="main_title">Vehicle Year</h2>
