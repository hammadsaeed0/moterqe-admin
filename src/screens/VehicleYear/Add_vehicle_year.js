...
const Add_vehicle_year = ({
  ...
  const bannerSubmit = async (values) => {
    if (values.title.value.length === 0) {
      ...
      await axios
        .post(`https://autoproapp-1537b3ac9acb.herokuapp.com/admin/year/create`, params)
        .then((res) => {
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        ...
        <div className="">
          <div className=" p-3 flex justify-between items-center">
            <div></div>
            <h1 className="capitalize h4 font-semibold">Add Vehicle Year</h1>
...
export default Add_vehicle_year;
