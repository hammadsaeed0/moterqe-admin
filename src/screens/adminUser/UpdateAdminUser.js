      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <div className="">
          <div className="p-3 flex justify-between items-center">
            <div></div>
            <h1 className="capitalize h4 font-semibold">Update Admin</h1>
              ...
              <div className="flex gap-5 flex-wrap">
                ...
                <div className="w-[100%]">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {["Dashboard", "Customer", "Admin Users", "Calculate Rate", "Master Status", "Customer Orders", "Create Orders", "Brands","Reports"].map((permission) => (
