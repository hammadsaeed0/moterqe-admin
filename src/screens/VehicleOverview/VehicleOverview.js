...
import Add_vehicle_overview from "./Add_vehicle_overview";
  ...
  const removeFunction = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://autoproapp-1537b3ac9acb.herokuapp.com/admin/vehicle/delete/${id}`)
          .then((res) => {
            console.log(res);
            if (res.status === 200) {
  ...
  return (
    <Wrapper>
      <div className=" flex   justify-between items-center">
        <div>
          <h2 className="main_title">Vehicle Overview</h2>
