...
const Add_vehicle_model = ({
  ...
  const bannerSubmit = async (values) => {
     if (values.title.value.length === 0) {
      ...
      toast.error("Please select your!");
    }else {
      setLoading(true)
      ...
      await axios
        .post(`https://autoproapp-1537b3ac9acb.herokuapp.com/admin/model/create`, params)
        .then((res) => {
          console.log(res.data);
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        ...
        <div className="">
          <div className=" p-3 flex justify-between items-center">
            <div></div>
            <h1 className="capitalize h4 font-semibold">Add Vehicle Model</h1>
...
export default Add_vehicle_model;
